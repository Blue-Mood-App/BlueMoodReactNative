const animationPaths = {
    "running": require("../assets/running.json"),
    "bowling": require("../assets/bowling.json"),
    "lasertag": require("../assets/laserTag.json"),
    "hiking": require("../assets/hiking.json"),
    "gardens": require("../assets/garden.json"),
